        ...
        <div class="row">  
            ...
            <div class="col-md-8">
                ...
                <div>
                  ...
                  @else
                  <img src="{{ asset('uploads/images/no-image-blog.jpg') }}" alt="" class="img-fluid  img-responisve">
                  @endif
                </div>                                  
                  {!! AppHelper::formatContent($posts->note) !!}  
                </div>  
                ...
                <div class="blog-item-comments">
                    ...
                    <div class="content">
                        ...
                        {!! AppHelper::formatContent($comm->comments) !!}
                        <div class="tools">
