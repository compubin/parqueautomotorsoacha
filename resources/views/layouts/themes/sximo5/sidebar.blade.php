...
<div id="sidebar-navigation">
    ...
    <div class="tools clearfix">
        <ul>
            <li><a href="{{ url('chat') }}"><i class="pe-7s-chat"></i></a></li>
            <li><a href="{{ url('dashboard/note') }}"><i class="pe-7s-note2"></i></a></li>
            <li><a href="{{ url('dashboard/dropzone') }}"><i class="pe-7s-folder"></i></a></li>
            <li><a href="{{ url('') }}" target="_blank"><i class="pe-7s-global"></i></a></li>
        </ul>
    </div>
            ...
            <div class="stats-label">
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                        <span class="font-extra-bold font-uppercase"> {{ session('username') }}</span>
                    </a>
