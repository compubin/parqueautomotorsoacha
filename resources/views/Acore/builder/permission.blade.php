  ...
  <div class="page-content-wrapper no-margin">
        ...
        <div class="sbox"  >
	    	<div class="sbox-title">
	    		<h4> {{ $row->module_title }} <small> : Permission  ( Set Access to Groups ) </small></h4>
	    	</div>        
            <div class="sbox-content">

			{!! Form::open(array('url'=>'builder/savepermission/'.$module_name, 'class'=>'form-horizontal' ,'id'=>'fPermission')) !!}


				@include('Acore.builder.tab',array('active'=>'permission','type'=>$type))
			...
			<div class="infobox infobox-danger fade in">
			  ...
			  <ol> 
				...
				<li> When you using this feature , Database table must have <strong><code>EntryBy</code></strong> field </li>
				</ol>	
			</div>	
