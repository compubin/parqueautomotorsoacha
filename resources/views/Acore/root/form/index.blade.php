        ...
        <div class="sbox"  >
            <div class="sbox-title" >   
				...
				<div class="sbox-tools">
					<a href="{{ url('root/form/update')}}" class="btn btn-sm  linkConfig tips ajaxCallback" title="New Table "><i class="fa fa-plus"></i> Create Form  </a>
				</div>                
            </div>
            	...
            	<div class="row">
	            	...
	            	<div class="col-md-2">
						...
						@foreach($forms as $form)
							<li><a href="{{ url('root/form/update?id='.$form->formID) }}" class="ajaxCallback"> {{ $form->name }}</a> </li>
						@endforeach
