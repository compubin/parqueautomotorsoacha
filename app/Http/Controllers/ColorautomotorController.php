...
class ColorautomotorController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'colorautomotor';
	static $per_page	= '10';

	public function __construct()
	{
		parent::__construct();
		$this->model = new Colorautomotor();
	...
	public function index( Request $request )
	{
		...
		return view('colorautomotor.index',$this->data);
	}	
}