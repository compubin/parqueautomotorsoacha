...
use App\Models\Estadoautomotor;
...
class EstadoautomotorController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'estadoautomotor';
	static $per_page	= '10';

	public function __construct()
	{
		parent::__construct();
		$this->model = new Estadoautomotor();
	...
	public function index( Request $request )
	{
		...
		return view('estadoautomotor.index',$this->data);
	}	
}