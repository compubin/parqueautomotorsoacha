...
use App\Models\Tipocarroceriaautomotor;
...
class TipocarroceriaautomotorController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'tipocarroceriaautomotor';
	static $per_page	= '10';

	public function __construct()
	{
		parent::__construct();
		$this->model = new Tipocarroceriaautomotor();
	...
	public function index( Request $request )
	{
		...
		return view('tipocarroceriaautomotor.index',$this->data);
	}	
}