...
use App\Models\Archivocombustible;
use App\Library\CrudEngine;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ;

class ArchivocombustibleController extends Controller {

    protected $layout = "layouts.main";
    protected $data = array();
    public $module = 'archivocombustible';
    static $per_page	= '10';

    public function __construct()
    {
        parent::__construct();
        $this->model = new Archivocombustible();
    ...
    public function index( Request $request )
    {
        ...
        return view('archivocombustible.index',$this->data);
    }
}