...
class FormController extends Controller {
   	...
   	public function index( Request $request )
	{
        ...
        return view('Acore.root.form.index',$this->data);
	}
    ...
    public function show( Request $request , $task )
    {
        ...
        {
            default:
                return view('Acore.root.form.form',$this->data);
                break;
            case 'field':
                ...
                return view('Acore.root.form.field',$this->data);
                break;

            case 'remove':
                $id = $request->input('id');
                \DB::table('tb_forms')->where('formID',$id)->delete();
                return redirect('root/form')->with(['status'=>'success','message'=>'Form has been deleted !']);
                break;    
            ...
            case 'update':
                ...
                return view('Acore.root.form.manage',$this->data);
                break;    
            case 'preview':
                $id = $request->input('id');
                return \FormHelper::render($id); 
                break;  
        }
