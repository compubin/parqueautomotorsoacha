...
class MarcaautomotorController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'marcaautomotor';
	static $per_page	= '10';

	public function __construct()
	{
		parent::__construct();
		$this->model = new Marcaautomotor();
	...
	public function index( Request $request )
	{
		...
		return view('marcaautomotor.index',$this->data);
	}	
}