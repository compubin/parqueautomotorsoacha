...
use App\Models\Tipocombustibleautomotor;
...
class TipocombustibleautomotorController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'tipocombustibleautomotor';
	static $per_page	= '10';

	public function __construct()
	{
		parent::__construct();
		$this->model = new Tipocombustibleautomotor();
	...
	public function index( Request $request )
	{
		...
		return view('tipocombustibleautomotor.index',$this->data);
	}	
}