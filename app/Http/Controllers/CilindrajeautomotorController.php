...
use App\Models\Cilindrajeautomotor;
...
class CilindrajeautomotorController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'cilindrajeautomotor';
	static $per_page	= '10';

	public function __construct()
	{
		parent::__construct();
		$this->model = new Cilindrajeautomotor();
	...
	public function index( Request $request )
	{
		...
		return view('cilindrajeautomotor.index',$this->data);
	}	
}